...
ByteVec sign = {0x4e, 0x54, 0x4c, 0x4d, 0x53, 0x53, 0x50, 0x00};
ByteVec typ1 = {0x01, 0x00, 0x00, 0x00};
ByteVec typ2 = {0x02, 0x00, 0x00, 0x00};
ByteVec typ3 = {0x03, 0x00, 0x00, 0x00};

ByteVec blob = {0x01, 0x01, 0x00, 0x00};
ByteVec zero = {0x00, 0x00, 0x00, 0x00};
