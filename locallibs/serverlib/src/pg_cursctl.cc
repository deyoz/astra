...
START_TEST(test_bind_int_after_long_int)
{
  ...
  {// ëÆß§†Ò¨ ™ÌË®‡Æ¢†≠≠Î© ™„‡·Æ‡, bind-®¨ Ø•‡•¨•≠≠„Ó long long int 
  ...
  { // Ø•‡•Æ‚™‡Î¢†•¨ ß†™ÌË®‡Æ¢†≠≠Î© ™„‡·Æ‡, ® bind-®¨ Ø•‡•¨•≠≠„Ó int
    // Ç ‡•ß„´Ï‚†‚• ¢ÎØÆ´≠•≠®Ô exec()  ØÆ´„Á†•¨ ÆË®°™„ "insufficient data left in message"
    int fld=999;
...
START_TEST(test_row)
{
    ...
    while (!cr.fen()) {
        if (i == 0) {
            ...
            // –∫–æ–Ω—Å—Ç—Ä—É–∫—Ç–æ—Ä enum –Ω–µ –ø—Ä–æ–≤–µ—Ä—è–µ—Ç –∑–Ω–∞—á–µ–Ω–∏–µ
            // –ø–æ—ç—Ç–æ–º—É –∏–º–µ–µ–º —Ç–∞–∫–æ–π —ç—Ñ—Ñ–µ–∫—Ç
