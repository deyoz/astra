...
class AirQPgCallbacks: public AirQCallbacks
{
    ...
    virtual void remove(const AirQFilter& f) const;
    ...
    virtual ~AirQPgCallbacks() {}
};

//---------------------------------------------------------------------------------------

class AirQPartPgCallbacks: public AirQPartCallbacks
{
public:
