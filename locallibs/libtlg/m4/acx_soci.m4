...
SOCI_ORACLE_CPPFLAGS="-I${SOCI_PREFIX}/include/soci/oracle"
SOCI_SQLITE3_CPPFLAGS="-I${SOCI_PREFIX}/include/soci/sqlite3"
...
SOCI_CPPFLAGS="-I${SOCI_PREFIX}/include/soci $SOCI_ORACLE_CPPFLAGS $SOCI_SQLITE3_CPPFLAGS"
AC_SUBST(SOCI_LIBS)
