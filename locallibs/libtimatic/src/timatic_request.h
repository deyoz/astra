...
public:
    ...
    const DocumentType &documentType() const { return documentType_; }
    const DocumentGroup &documentGroup() const { return documentGroup_; }
    // mandatory2
    ...
    const Optional<ResidencyDocument> &residencyDocument() const { return residencyDocument_; }
    // optional
    ...
    const Optional<boost::posix_time::ptime> &expiryDateGMT() const { return expiryDateGMT_; }
    ...
    const Optional<SecondaryDocumentType> &secondaryDocumentType() const { return secondaryDocumentType_; }
    ...
    void documentType(const DocumentType &val) { documentType_ = val; }
    void documentGroup(const DocumentGroup &val) { documentGroup_ = val; }
    ...
    void residencyDocument(const ResidencyDocument &val) { residencyDocument_ = val; }
    // optional
    ...
    void secondaryDocumentType(const SecondaryDocumentType &val) { secondaryDocumentType_ = val; }
...
private:
    ...
    Optional<ResidencyDocument> residencyDocument_;
    // optional
    ...
    Optional<boost::posix_time::ptime> expiryDateGMT_;
    ...
    Optional<SecondaryDocumentType> secondaryDocumentType_;
...
const std::map<RequestType, ParamValue> &getRequestTypeMap();
std::string toString(const RequestType &val);
