...
BAG_REFUSE INT NOT NULL, --number(1)
BAG_TYPES_ID INT, --NUMBER(9)
CLASS VARCHAR(1),
CLASS_GRP INT, --NUMBER(9)
CLIENT_TYPE VARCHAR(5) NOT NULL,
DESK VARCHAR(6),
EXCESS INT, --NUMBER(4)
EXCESS_PC INT, --NUMBER(4)
EXCESS_WT INT, --NUMBER(4)
GRP_ID INT NOT NULL, --number(9)
HALL INT, --NUMBER(9)
PART_KEY TIMESTAMP NOT NULL,
PIECE_CONCEPT INT, --NUMBER(1)
POINT_ARV INT NOT NULL, --number(9)
POINT_DEP INT NOT NULL, --number(9)
POINT_ID_MARK INT NOT NULL, --number(9)
PR_MARK_NORMS INT NOT NULL, --number(1)
STATUS VARCHAR(1) NOT NULL,
TID INT NOT NULL, --number(9)
TIME_CREATE TIMESTAMP,
USER_ID INT --NUMBER(9)
/*
