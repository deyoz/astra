...
ADULT INT NOT NULL, --number(3)
BABY INT NOT NULL, --number(3)
CHILD INT NOT NULL, --number(3)
...
TCKIN INT NOT NULL, --number(3)
TERM_BAG INT, --NUMBER(3)
TERM_BP INT, --NUMBER(3)
TERM_CKIN_SERVICE INT --NUMBER(3)
/*
