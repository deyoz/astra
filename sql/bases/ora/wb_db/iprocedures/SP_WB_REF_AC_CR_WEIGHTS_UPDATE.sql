create or replace procedure SP_WB_REF_AC_CR_WEIGHTS_UPDATE
(cXML_in in clob,
   cXML_out out clob)
as
P_ID number:=-1;
...
R_COUNT int:=0;
  begin
   ...
   if P_CC_BAGGAGE_WEIGHT_INT_PART<>'NULL'
    ...
    if (str_msg is null) then
      begin
        ...
        set DESCRIPTION=P_DESCRIPTION,
	          ...
	          FC_STANDART=P_FC_STANDART,
	          FC_MALE=P_FC_MALE,
	          FC_FEMALE=P_FC_FEMALE,
	          FC_HAND_BAG=P_FC_HAND_BAG,
	          FC_HAND_BAG_INCLUDE=P_FC_HAND_BAG_INCLUDE,
	          CC_STANDART=P_CC_STANDART,
	          CC_MALE=P_CC_MALE,
	          CC_FEMALE=P_CC_FEMALE,
	          CC_HAND_BAG=P_CC_HAND_BAG,
	          CC_HAND_BAG_INCLUDE=P_CC_HAND_BAG_INCLUDE,
	          FC_BAGGAGE_WEIGHT=P_FC_BAGGAGE_WEIGHT,
	          CC_BAGGAGE_WEIGHT=P_CC_BAGGAGE_WEIGHT,
    ...
    commit;
  end SP_WB_REF_AC_CR_WEIGHTS_UPDATE;
/
