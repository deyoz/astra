CREATE TABLE WB_REF_AIRCO_LOAD_CODES_HIST (
...
DENSITY_NEW NUMBER NOT NULL,
DENSITY_OLD NUMBER NOT NULL,
DESCRIPTION_NEW VARCHAR2(1000) NOT NULL,
DESCRIPTION_OLD VARCHAR2(1000) NOT NULL,
IATA_CODE_ID_NEW NUMBER NOT NULL,
IATA_CODE_ID_OLD NUMBER NOT NULL,
ID NUMBER NOT NULL,
ID_ NUMBER NOT NULL,
ID_AC_NEW NUMBER NOT NULL,
ID_AC_OLD NUMBER NOT NULL,
PRIORITY_NEW NUMBER NOT NULL,
PRIORITY_OLD NUMBER NOT NULL,
