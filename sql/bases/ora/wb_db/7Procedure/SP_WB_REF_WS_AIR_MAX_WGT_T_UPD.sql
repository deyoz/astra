create or replace procedure SP_WB_REF_WS_AIR_MAX_WGT_T_UPD
(cXML_in in clob,
   cXML_out out clob)
as
P_ID number:=-1;
...
P_MAX_RMP_WEIGHT number:=null;
P_MAX_ZF_WEIGHT number:=null;
P_MAX_TO_WEIGHT number:=null;
P_MAX_LND_WEIGHT number:=null;

P_MAX_RMP_WEIGHT_INT_PART varchar2(50):='NULL';
P_MAX_RMP_WEIGHT_DEC_PART varchar2(50):='NULL';

P_MAX_ZF_WEIGHT_INT_PART varchar2(50):='NULL';
P_MAX_ZF_WEIGHT_DEC_PART varchar2(50):='NULL';

P_MAX_TO_WEIGHT_INT_PART varchar2(50):='NULL';
P_MAX_TO_WEIGHT_DEC_PART varchar2(50):='NULL';

P_MAX_LND_WEIGHT_INT_PART varchar2(50):='NULL';
P_MAX_LND_WEIGHT_DEC_PART varchar2(50):='NULL';
...
V_R_COUNT int:=0;
  begin
    ...
    select extractValue(xmltype(cXML_in),'/root[1]/list[1]/P_MAX_RMP_WEIGHT_INT_PART[1]') into P_MAX_RMP_WEIGHT_INT_PART from dual;
    select extractValue(xmltype(cXML_in),'/root[1]/list[1]/P_MAX_RMP_WEIGHT_DEC_PART[1]') into P_MAX_RMP_WEIGHT_DEC_PART from dual;

    select extractValue(xmltype(cXML_in),'/root[1]/list[1]/P_MAX_ZF_WEIGHT_INT_PART[1]') into P_MAX_ZF_WEIGHT_INT_PART from dual;
    select extractValue(xmltype(cXML_in),'/root[1]/list[1]/P_MAX_ZF_WEIGHT_DEC_PART[1]') into P_MAX_ZF_WEIGHT_DEC_PART from dual;

    select extractValue(xmltype(cXML_in),'/root[1]/list[1]/P_MAX_TO_WEIGHT_INT_PART[1]') into P_MAX_TO_WEIGHT_INT_PART from dual;
    select extractValue(xmltype(cXML_in),'/root[1]/list[1]/P_MAX_TO_WEIGHT_DEC_PART[1]') into P_MAX_TO_WEIGHT_DEC_PART from dual;

    select extractValue(xmltype(cXML_in),'/root[1]/list[1]/P_MAX_LND_WEIGHT_INT_PART[1]') into P_MAX_LND_WEIGHT_INT_PART from dual;
    select extractValue(xmltype(cXML_in),'/root[1]/list[1]/P_MAX_LND_WEIGHT_DEC_PART[1]') into P_MAX_LND_WEIGHT_DEC_PART from dual;
   ...
   P_MAX_RMP_WEIGHT:=to_number(P_MAX_RMP_WEIGHT_INT_PART||'.'||P_MAX_RMP_WEIGHT_DEC_PART);
   P_MAX_ZF_WEIGHT:=to_number(P_MAX_ZF_WEIGHT_INT_PART||'.'||P_MAX_ZF_WEIGHT_DEC_PART);
   P_MAX_TO_WEIGHT:=to_number(P_MAX_TO_WEIGHT_INT_PART||'.'||P_MAX_TO_WEIGHT_DEC_PART);
   P_MAX_LND_WEIGHT:=to_number(P_MAX_LND_WEIGHT_INT_PART||'.'||P_MAX_LND_WEIGHT_DEC_PART);

    cXML_out:='<?xml version="1.0" ?><root>';
    ----------------------------------------------------------------------------
    ----------------------------------------------------------------------------
    select count(id) into V_R_COUNT
    from WB_REF_WS_AIR_MAX_WGHT_T
    where ID=P_ID;
    ...
    if (V_STR_MSG is null) then
      begin
        update WB_REF_WS_AIR_MAX_WGHT_T
        set ID_BORT=P_ID_BORT_T,
            MAX_RMP_WEIGHT=P_MAX_RMP_WEIGHT,
	          MAX_ZF_WEIGHT=P_MAX_ZF_WEIGHT,
	          MAX_TO_WEIGHT=P_MAX_TO_WEIGHT,
	          MAX_LND_WEIGHT=P_MAX_LND_WEIGHT,
    ...
    commit;
  end SP_WB_REF_WS_AIR_MAX_WGT_T_UPD;
/
