create or replace procedure SP_WB_REF_WS_AIR_MIN_WGHT_UPD
(cXML_in in clob,
   cXML_out out clob)
as
P_ID number:=-1;
...
V_ACTION_NAME varchar2(100):='SP_WB_REF_WS_AIR_MIN_WGHT_UPD';
V_ACTION_DATE date:=sysdate();
  begin
    ...
    if (V_STR_MSG is null) then
      begin
        UPDATE WB_REF_WS_AIR_MIN_WGHT_IDN
	                                           ...
	                                           d.OPER_ID_2,
                                                 ...
                                                 d.U_NAME,
		                               	               d.U_IP,
		                                	               d.U_HOST_NAME,
		                                 	                 d.DATE_WRITE
        from WB_REF_WS_AIR_MIN_WGHT_USE d
        where d.idn=P_ID;

        delete from WB_REF_WS_AIR_MIN_WGHT_USE where idn=P_ID;

        insert into WB_REF_WS_AIR_MIN_WGHT_USE (ID,
	                                                ID_AC,
	                                                  ID_WS,
		                                                  ID_BORT,
		                                                    IDN,
	                                                                ...
	                                                                VALUE_2,
	                                                                  U_NAME,
	                                                                    U_IP,
	                                                                      U_HOST_NAME,
	                                                                        DATE_WRITE)
       select SEC_WB_REF_WS_AIR_MN_WT_USE.nextval,
                a.ID_AC,
	                a.ID_WS,
		                a.ID_BORT,
		                  a.ID,
                                ...
                                t.f_flt_3,
                                  P_U_NAME,
	                                  P_U_IP,
	                                    P_U_HOST_NAME,
	                                      sysdate()
       from WB_REF_WS_AIR_MIN_WGHT_IDN a join WB_TEMP_XML_ID_EX t
       on a.id=P_ID and
    ...
    commit;
  end SP_WB_REF_WS_AIR_MIN_WGHT_UPD;
/
