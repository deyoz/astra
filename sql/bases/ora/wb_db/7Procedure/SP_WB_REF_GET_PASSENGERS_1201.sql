create or replace PROCEDURE SP_WB_REF_GET_PASSENGERS_1201(cXML_in IN clob,
                                           cXML_out OUT CLOB)
AS
...
BEGIN
  ...
  if REC_COUNT > 0 then
    ...
    begin
      ...
      with tblARRs as
      (
        select t2.ELEM_ID, t2.ID_AP1, t2.ID_AP2, 'русский' RU_ID, t6.CLASS_CODE
...
END SP_WB_REF_GET_PASSENGERS_1201;
/
