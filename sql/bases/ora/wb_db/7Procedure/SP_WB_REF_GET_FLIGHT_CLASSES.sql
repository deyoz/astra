create or replace PROCEDURE SP_WB_REF_GET_FLIGHT_CLASSES
(cXML_in in clob,
   cXML_out out clob)
AS
cXML_data XMLType;
...
BEGIN
  ...
  with tblPassBag as
  (
    select distinct t2.ELEM_ID, t9.NAME_ENG_SMALL Units, t7.ID ID_CLASS, t6.CLASS_CODE, t10.ADULT, t10.MALE, t10.FEMALE, t10."CHILD", t10.INFANT
    /*
    from WB_REF_WS_SCHED_TEMP t1 inner join WB_REF_SCHED_MRSHR_TEMP t2 on t1.ID = t2.ELEM_ID
                                ...
                                inner join WB_REF_WS_AIR_SL_CI_T t6 on t1.ID_AC = t6.ID_AC and t1.ID_WS = t6.ID_WS and t5.ID = t6.ADV_ID
  ...
  commit;
END SP_WB_REF_GET_FLIGHT_CLASSES;
/
