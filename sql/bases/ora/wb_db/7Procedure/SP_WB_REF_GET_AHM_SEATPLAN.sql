create or replace PROCEDURE SP_WB_REF_GET_AHM_SEATPLAN
(cXML_in in clob,
   cXML_out out clob)
AS
...
BEGIN
  ...
  (
    ...
    (
      ...
      where t1.ID_AC = vID_AC and t1.ID_WS = vID_WS and t3.IDN = vID_SL -- and t1.ID_BORT = vID_BORT
    ) tt1
    left join
    (
      ...
      (
        ...
        (
          ...
          where t1.ID_AC = vID_AC and t1.ID_WS = vID_WS and t6.IDN = vID_SL -- and t1.ID_BORT = vID_BORT
        ) t1
  ...
  commit;
END SP_WB_REF_GET_AHM_SEATPLAN;
/
