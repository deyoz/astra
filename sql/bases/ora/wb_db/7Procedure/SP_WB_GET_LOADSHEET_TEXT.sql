create or replace PROCEDURE SP_WB_GET_LOADSHEET_TEXT
...
LIZFW    '
|| to_char(f36c, '99.99') || ' MACZFW    ' || to_char(f36f, '99999999.99')
|| '
LITOW    '
|| to_char(f36d, '99.99') || ' MACTOW    ' || to_char(f36g, '99999999.99')
|| '
LILAW    '
|| to_char(f36e, '99.99') || ' MACLAW    ' || to_char(f36h, '99999999.99')
|| '
