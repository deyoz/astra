...
int prn_tst(int argc, char **argv)
{
    string qry =
        ...
        "<term>"
        "  <query handle='0' id='print' ver='1' opr='ННРСМИРНОВА' screen='AIR.EXE' mode='STAND' lang='RU' term_id='3340624862'>"
        "    <GetPrintDataBP>"
        "      <grp_id>167546495</grp_id>"
        "      <pax_id>189922290</pax_id>"
    ...
    reqInfo->desk.code = "MOVDEN";
    reqInfo->desk.version = "201509-0173355";
    XMLRequestCtxt *ctxt = getXmlCtxt();
    JxtInterfaceMng::Instance()->
        GetInterface("print")->
        OnEvent("GetPrintDataBP",  ctxt,
