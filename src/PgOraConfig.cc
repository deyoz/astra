...
namespace PgOra
{
    ...
    static const GroupsType sGroups {
        ...
        { "SP_PG_GROUP_PAX_SERVICES",{ "SERVICE_PAYMENT", "PAX_SERVICES", "PAX_SERVICES_AUTO", "PAY_SERVICES" } },
        ...
        { "SP_PG_GROUP_PAX_EVENTS",{
                "PAX_EVENTS",
                "PAX_CUSTOM_ALARMS",  // "CUSTOM_ALARM_TYPES"
                "CUSTOM_ALARM_TYPES", "HIST_CUSTOM_ALARM_TYPES" // "PAX_CUSTOM_ALARMS"
        } },
