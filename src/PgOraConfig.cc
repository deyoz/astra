...
namespace PgOra
{
    ...
    static const GroupsType sGroups {
        ...
        { "SP_PG_GROUP_HOTEL_ACMD",{ "HOTEL_ACMD_DATES", "HOTEL_ACMD_FREE_PAX", "HOTEL_ACMD_PAX", "HOTEL_ACMD", "HIST_HOTEL_ACMD" } },
        ...
        { "SP_PG_GROUP_COMP_ELEMS", {
                "COMP_ELEMS", // COMP_BASELAYERS, TRIP_COMP_RATES, TRIP_COMP_RFISC, TRIP_COMP_REM, TRIP_COMP_BASELAYERS, TRIP_COMP_ELEMS, TRIP_COMP_LAYERS, COMP_ELEMS, COMP_REM, COMP_RFISC, COMP_RATES + `````7Proc/SALONS````` (from trigger COMP_ELEMS__BEFORE__TRG) !
        }},
        { "SP_PG_GROUP_COMP_RATES", {
                "COMP_RATES", // COMP_BASELAYERS, TRIP_COMP_RATES, TRIP_COMP_RFISC, TRIP_COMP_REM, TRIP_COMP_BASELAYERS, TRIP_COMP_ELEMS, TRIP_COMP_LAYERS, COMP_ELEMS, COMP_REM, COMP_RFISC, COMP_RATES
        }},
    };
