...
namespace PgOra
{
    ...
    static const GroupsType sGroups {
        ...
        { "SP_PG_GROUP_HOTEL_ACMD",{ "HOTEL_ACMD_DATES", "HOTEL_ACMD_FREE_PAX", "HOTEL_ACMD_PAX" } },
        ...
        { "SP_PG_GROUP_STAGES", { "GRAPH_RULES", "GRAPH_STAGES", "GRAPH_TIMES", "STAGE_NAMES", "STAGE_SETS", "STAGE_STATUSES", "STAGE_TYPES", "CKIN_CLIENT_STAGES", "TRIP_FINAL_STAGES", "TRIP_STAGES", "TRIP_CKIN_CLIENT" } },
