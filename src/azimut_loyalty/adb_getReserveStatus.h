        ...
        #ifndef ADB_GETRESERVESTATUS_H
        #define ADB_GETRESERVESTATUS_H

       /**
        * adb_getReserveStatus.h
        *
        ...
        */
        ...
        typedef struct adb_getReserveStatus adb_getReserveStatus_t;
        ...
        /**
         * Constructor for creating adb_getReserveStatus_t
         * @param env pointer to environment struct
         * @return newly created adb_getReserveStatus_t object
         */
         ...
         * @param  _getReserveStatus adb_getReserveStatus_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_getReserveStatus_t object
         * @param  _getReserveStatus adb_getReserveStatus_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        ...
        /**
         * Getter for request. 
         * @param  _getReserveStatus adb_getReserveStatus_t object
         * @param env pointer to environment struct
         * @return adb_ReserveStatusRequest_t*
         */
         ...
         * @param  _getReserveStatus adb_getReserveStatus_t object
         * @param env pointer to environment struct
         * @param arg_request adb_ReserveStatusRequest_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       adb_getReserveStatus_declare_parent_namespaces(
         ...
         * @param  _getReserveStatus adb_getReserveStatus_t object
         * @param env pointer to environment struct
         * @param getReserveStatus_om_node node to serialize from
         * @param getReserveStatus_om_element parent element to serialize from
        ...
        adb_getReserveStatus_serialize(
            adb_getReserveStatus_t* _getReserveStatus,
            const axutil_env_t *env,
            axiom_node_t* getReserveStatus_om_node, axiom_element_t *getReserveStatus_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_getReserveStatus is a particle class (E.g. group, inner sequence)
         ...
         * Constructor for creating adb_getReserveStatus_t
         * @param env pointer to environment struct
         * @param _request adb_ReserveStatusRequest_t*
         * @return newly created adb_getReserveStatus_t object
         */
        adb_getReserveStatus_t* AXIS2_CALL
        adb_getReserveStatus_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_getReserveStatus_t object and return the property value.
