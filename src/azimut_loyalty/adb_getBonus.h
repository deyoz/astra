        ...
        #ifndef ADB_GETBONUS_H
        #define ADB_GETBONUS_H
        ...
        */
        ...
        typedef struct adb_getBonus adb_getBonus_t;
        ...
        /**
         * Constructor for creating adb_getBonus_t
         * @param env pointer to environment struct
         * @return newly created adb_getBonus_t object
         */
         ...
         * @param  _getBonus adb_getBonus_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Getter for request. 
         * @param  _getBonus adb_getBonus_t object
         * @param env pointer to environment struct
         * @return adb_BonusRequest_t*
         */
         ...
         * @param  _getBonus adb_getBonus_t object
         * @param env pointer to environment struct
         * @param arg_request adb_BonusRequest_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       adb_getBonus_declare_parent_namespaces(
         ...
         * @param  _getBonus adb_getBonus_t object
         * @param env pointer to environment struct
         * @param getBonus_om_node node to serialize from
         * @param getBonus_om_element parent element to serialize from
        ...
        adb_getBonus_serialize(
            adb_getBonus_t* _getBonus,
            const axutil_env_t *env,
            axiom_node_t* getBonus_om_node, axiom_element_t *getBonus_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_getBonus is a particle class (E.g. group, inner sequence)
         ...
         * Constructor for creating adb_getBonus_t
         * @param env pointer to environment struct
         * @param _request adb_BonusRequest_t*
         * @return newly created adb_getBonus_t object
         */
        adb_getBonus_t* AXIS2_CALL
        adb_getBonus_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_getBonus_t object and return the property value.
