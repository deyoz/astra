        ...
        #ifndef ADB_CANCELRESERVERESPONSE_H
        #define ADB_CANCELRESERVERESPONSE_H

       /**
        * adb_CancelReserveResponse.h
        *
       ...
       /**
        *  adb_CancelReserveResponse class
        */
        ...
        typedef struct adb_CancelReserveResponse adb_CancelReserveResponse_t;
        ...
        /**
         * Constructor for creating adb_CancelReserveResponse_t
         * @param env pointer to environment struct
         * @return newly created adb_CancelReserveResponse_t object
         */
         ...
         * @param  _CancelReserveResponse adb_CancelReserveResponse_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_CancelReserveResponse_t object
         * @param  _CancelReserveResponse adb_CancelReserveResponse_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        ...
        /**
         * Getter for errors. Deprecated for array types, Use adb_CancelReserveResponse_get_errors_at instead
         * @param  _CancelReserveResponse adb_CancelReserveResponse_t object
         * @param env pointer to environment struct
        ...
        /**
         * Setter for errors.Deprecated for array types, Use adb_CancelReserveResponse_set_errors_at
         * or adb_CancelReserveResponse_add_errors instead.
         * @param  _CancelReserveResponse adb_CancelReserveResponse_t object
         * @param env pointer to environment struct
         ...
         * @param  _CancelReserveResponse _ adb_CancelReserveResponse_t object
         * @param env pointer to environment struct.
       ...
       adb_CancelReserveResponse_declare_parent_namespaces(
         ...
         * @param  _CancelReserveResponse adb_CancelReserveResponse_t object
         * @param env pointer to environment struct
         * @param CancelReserveResponse_om_node node to serialize from
         * @param CancelReserveResponse_om_element parent element to serialize from
        ...
        adb_CancelReserveResponse_serialize(
            adb_CancelReserveResponse_t* _CancelReserveResponse,
            const axutil_env_t *env,
            axiom_node_t* CancelReserveResponse_om_node, axiom_element_t *CancelReserveResponse_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_CancelReserveResponse is a particle class (E.g. group, inner sequence)
        ...
        adb_CancelReserveResponse_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_CancelReserveResponse_t object and return the property value.
     ...
     #endif /* ADB_CANCELRESERVERESPONSE_H */
