        ...
        #ifndef ADB_ERRORGROUPRESPONSE_H
        #define ADB_ERRORGROUPRESPONSE_H

       /**
        * adb_ErrorGroupResponse.h
        *
        ...
        */
        ...
        typedef struct adb_ErrorGroupResponse adb_ErrorGroupResponse_t;
        ...
        /**
         * Constructor for creating adb_ErrorGroupResponse_t
         * @param env pointer to environment struct
         * @return newly created adb_ErrorGroupResponse_t object
         */
         ...
         * @param  _ErrorGroupResponse adb_ErrorGroupResponse_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_ErrorGroupResponse_t object
         * @param  _ErrorGroupResponse adb_ErrorGroupResponse_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        ...
        /**
         * Getter for errors. Deprecated for array types, Use adb_ErrorGroupResponse_get_errors_at instead
         * @param  _ErrorGroupResponse adb_ErrorGroupResponse_t object
         * @param env pointer to environment struct
        ...
        /**
         * Setter for errors.Deprecated for array types, Use adb_ErrorGroupResponse_set_errors_at
         * or adb_ErrorGroupResponse_add_errors instead.
         * @param  _ErrorGroupResponse adb_ErrorGroupResponse_t object
         * @param env pointer to environment struct
         ...
         * @param  _ErrorGroupResponse _ adb_ErrorGroupResponse_t object
         * @param env pointer to environment struct.
       ...
       adb_ErrorGroupResponse_declare_parent_namespaces(
         ...
         * @param  _ErrorGroupResponse adb_ErrorGroupResponse_t object
         * @param env pointer to environment struct
         * @param ErrorGroupResponse_om_node node to serialize from
         * @param ErrorGroupResponse_om_element parent element to serialize from
        ...
        adb_ErrorGroupResponse_serialize(
            adb_ErrorGroupResponse_t* _ErrorGroupResponse,
            const axutil_env_t *env,
            axiom_node_t* ErrorGroupResponse_om_node, axiom_element_t *ErrorGroupResponse_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_ErrorGroupResponse is a particle class (E.g. group, inner sequence)
        ...
        adb_ErrorGroupResponse_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_ErrorGroupResponse_t object and return the property value.
     ...
     #endif /* ADB_ERRORGROUPRESPONSE_H */
