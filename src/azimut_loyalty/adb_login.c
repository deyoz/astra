        ...
        #include "adb_login.h"
               ...
               /*
                * implmentation of the login|http://ffpServer.aeronavigator.ru element
                */
        ...
        struct adb_login
        {
            ...
            adb_LoginRequest_t* property_request;
       ...
       /************************* Function Implmentations ********************************/
            ...
            const axutil_env_t *env)
        {
            ...
            _login->property_request  = NULL;
                  _login->is_valid_request  = AXIS2_FALSE;
        ...
        adb_LoginRequest_t* AXIS2_CALL
                adb_login_free_popping_value(
                        ...
                        const axutil_env_t *env)
                {
                    adb_LoginRequest_t* value;

                    
                    
                    value = _login->property_request;

                    _login->property_request = (adb_LoginRequest_t*)NULL;
                ...
                const axutil_env_t *env)
        {
            ...
            adb_login_reset_request(_login, env);
                ...
                return AXIS2_FAILURE;
                    ...
                    else
                    {
                      ...
                      */
                           ...
                           if (adb_LoginRequest_is_particle() ||  
                                (current_node   && current_element && (axutil_qname_equals(element_qname, env, qname))))
                           {
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, env, qname)))
                              {
                                is_early_node_valid = AXIS2_TRUE;
                                      ...
                                      element = (void*)axis2_extension_mapper_create_from_node(env, &current_node, "adb_LoginRequest");

                                      status =  adb_LoginRequest_deserialize((adb_LoginRequest_t*)element,
                                      ...
                                      {
                                          status = adb_login_set_request(_login, env,
                                                                   (adb_LoginRequest_t*)element);
                                      }
                ...
                const axutil_env_t *env, axiom_node_t *parent, axiom_element_t *parent_element, int parent_tag_closed, axutil_hash_t *namespaces, int *next_ns_index)
        {
         ...
         int tag_closed = 0;
                   ...
                   else
                   {
                      ...
                      */
                        ...
                        end_input_str_len = axutil_strlen(end_input_str);
                            ...
                            adb_LoginRequest_serialize(_login->property_request, 
                                                                                 env, current_node, parent_element,
                                                                                 adb_LoginRequest_is_particle() || AXIS2_FALSE, namespaces, next_ns_index);
            ...
            adb_login_get_property1(
                ...
                const axutil_env_t *env)
            {
                return adb_login_get_request(_login,
                                             env);
            }
            ...
            adb_login_get_request(
                    ...
                    const axutil_env_t *env)
             {
                ...
                return _login->property_request;
             }
            ...
            adb_login_set_request(
                    ...
                    adb_LoginRequest_t*  arg_request)
             {
                ...
                if(_login->is_valid_request &&
                        arg_request == _login->property_request)
                {
                ...
                _login->property_request = arg_request;
                        _login->is_valid_request = AXIS2_TRUE;
                   ...
                   const axutil_env_t *env)
           {
               ...
               AXIS2_PARAM_CHECK(env->error, _login, AXIS2_FAILURE);
                ...
                if(_login->property_request != NULL)
                {
                   
                   adb_LoginRequest_free(_login->property_request, env);
                     _login->property_request = NULL;
                }
                   ...
                   const axutil_env_t *env)
           {
               ...
               return !_login->is_valid_request;
           }
           ...
           adb_login_set_request_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_login_reset_request(_login, env);
           }
