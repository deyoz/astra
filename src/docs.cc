...
void PTM(TRptParams &rpt_params, xmlNodePtr reqNode, xmlNodePtr resNode)
{
    ...
    for(; !Qry.Eof; Qry.Next()) {
        ...
        NewTextChild(rowNode, "remarks",
                (rpt_params.pr_et ? Qry.FieldAsString("remarks") : GetRemarkStr(rem_grp, pax_id, TReqInfo::Instance()->desk.lang == AstraLocale::LANG_EN)));
    }
...
void EXAM(TRptParams &rpt_params, xmlNodePtr reqNode, xmlNodePtr resNode)
{
    ...
    if(!Qry.Eof)
    {
      ...
      for( ; !Qry.Eof; Qry.Next()) {
        ...
        NewTextChild(paxNode, "remarks", GetRemarkStr(rem_grp, pax_id, TReqInfo::Instance()->desk.lang == AstraLocale::LANG_EN));
      }
    }
