...
class TBalanceData
{
  ...
  void init() {
    ...
    if ( dataFlags.isFlag( tdPass ) ) {
      ...
      qPassQry->CreateVariable( "adl", otString, "‚‡" );
      qPassQry->CreateVariable( "male", otString, "M" );
      qPassQry->CreateVariable( "female", otString, "F" );
      qPassQry->CreateVariable( "chd", otString, "" );
      qPassQry->CreateVariable( "inf", otString, "Œ" );
      ...
      qPassTQry->CreateVariable( "adl", otString, "‚‡" );
      qPassTQry->CreateVariable( "male", otString, "M" );
      qPassTQry->CreateVariable( "female", otString, "F" );
      qPassTQry->CreateVariable( "chd", otString, "" );
      qPassTQry->CreateVariable( "inf", otString, "Œ" );
    }
