...
class componPropCodes {
  ...
  public:
    componPropCodes() {
      codes = { make_pair(TAIL,CodeNames("Хвост","Tail","$00400080")),
                make_pair(NOSE,CodeNames("Нос","Nose","$00FF8000")),
                make_pair(SECTION,CodeNames("Секция","Section","clGray")),
                make_pair(WING,CodeNames("Крыло","Wing","clOlive")) };
      lexemas = {
