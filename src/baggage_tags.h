...
extern void BagTagContainerFromDB(std::multimap<TBagTagNumber, TBagItem>& container, DB::TQuery& Qry, bool includeTagColor);

template <typename T>
extern void GetTagsByPool(int grp_id, int bag_pool_num , T& container, bool includeTagColor);
