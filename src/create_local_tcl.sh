...
set SP_PG_GROUP_PAX_TRANSLIT 0
set SP_PG_GROUP_STAT_ORDERS 3
set SP_PG_GROUP_BAG_NAMES 3
set SP_PG_GROUP_STAT_2 3
set SP_PG_GROUP_STAT_3 0
set SP_PG_GROUP_KUF_STAT 3
set SP_PG_GROUP_CKIN_CLIENT 3
set SP_PG_GROUP_HALLS_TERMINALS 3
set SP_PG_GROUP_DEV 3
set SP_PG_GROUP_PRN_FORM_BX_MODELS 3
set SP_PG_GROUP_AIRLINE_OFFICES 3

set SP_PG_GROUP_POS_TERM 3
set SP_PG_GROUP_TASKS 3
set SP_PG_GROUP_TAG_PACKS 3
set SP_PG_GROUP_TYPEB_HELP 3
...
set SP_PG_GROUP_BASETABLES_HIST 3
...
set SP_PG_GROUP_TYPEB_ADDRS 0
set SP_PG_GROUP_TYPEB_SEND 0
set SP_PG_GROUP_TYPEB_ORIGINATORS 0
...
set SP_PG_GROUP_RFISC_BRANDS 3
set SP_PG_GROUP_COMP_TRIP_COMP_RATES 3
set SP_PG_GROUP_PLACE_CALC 3
set SP_PG_GROUP_KIOSKS 3
set SP_PG_GROUP_LIBRA 3
set SP_PG_GROUP_CODESHARE_SETS 3
set SP_PG_GROUP_REMRES 3
set SP_PG_GROUP_EVENTS 0
set SP_PG_GROUP_EVENTS_SEQ 0
set SP_PG_GROUP_EDICFG 3
set SP_PG_GROUP_TRIP_COMP_RFISC 3
set SP_PG_GROUP_TRIP_COMP_REM 3
set SP_PG_GROUP_BALANCE_SETS 3
set SP_PG_GROUP_BALANCE_TYPES 3
set SP_PG_GROUP_PAY_METHODS 3
set SP_PG_GROUP_FAKE_DUAL_BT 3
set SP_PG_GROUP_FOREIGN_SCAN 3
set SP_PG_GROUP_HTTP 3
set SP_PG_GROUP_APIS 3
set SP_PG_GROUP_EXCH_FLIGHTS 3
set SP_PG_GROUP_TIMATIC 3
set SP_PG_GROUP_PAX_SEATS 0
set SP_PG_GROUP_RATE_COLORS 3
set SP_PG_GROUP_SERVICE_TYPES 3
set SP_PG_GROUP_TERM_MODES 3
set SP_PG_GROUP_TERM_PARAM_AIRLINES 0
