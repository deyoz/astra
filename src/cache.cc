...
const
  struct
  {
    ...
    TElemType ElemType;
                         ...
                         {"TYPEB_LCI_ACTION_CODE",   etTypeBOptionValues},
                         {"TYPEB_LCI_SEAT_RESTRICT", etTypeBOptionValues},
                         {"TYPEB_LCI_WEIGHT_AVAIL",  etTypeBOptionValues},
                         {"TYPEB_LDM_VERSION",       etTypeBOptionValues},
                         {"TYPEB_PRL_CREATE_POINT",  etTypeBOptionValues},
                         {"TYPEB_PRL_PAX_STATE",     etTypeBOptionValues},
