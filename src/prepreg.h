...
public:
  PrepRegInterface() : JxtInterface("","prepreg")
  {
     ...
     evHandle=JxtHandler<PrepRegInterface>::CreateHandler(&PrepRegInterface::UpdateCRSList);
     AddEvent("UpdateCRSList",evHandle);
  };
  ...
  void UpdateCRSList(XMLRequestCtxt *ctxt, xmlNodePtr reqNode, xmlNodePtr resNode);
