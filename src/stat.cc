                         ...
                         const TPrintAirline &airline, xmlNodePtr resNode)
{
    ...
    if(params.statType != statPactShort) {
        colNode = NewTextChild(headerNode, "col", getLocaleText("Web/б/п"));
        SetProp(colNode, "width", 85);
        SetProp(colNode, "align", taRightJustify);
        SetProp(colNode, "sort", sortSlashedInt);
        NewTextChild(rowNode, "col", total.web_str());

        colNode = NewTextChild(headerNode, "col", getLocaleText("Киоски/б/п"));
        SetProp(colNode, "width", 85);
        SetProp(colNode, "align", taRightJustify);
        SetProp(colNode, "sort", sortSlashedInt);
        NewTextChild(rowNode, "col", total.kiosk_str());

        colNode = NewTextChild(headerNode, "col", getLocaleText("Mobcek/б/п"));
        SetProp(colNode, "width", 85);
        SetProp(colNode, "align", taRightJustify);
        SetProp(colNode, "sort", sortSlashedInt);
                        ...
                        const TPrintAirline &airline, xmlNodePtr resNode)
{
    ...
    colNode = NewTextChild(headerNode, "col", getLocaleText("Пас./б/п"));
    SetProp(colNode, "width", 85);
    SetProp(colNode, "align", taRightJustify);
    SetProp(colNode, "sort", sortSlashedInt);
