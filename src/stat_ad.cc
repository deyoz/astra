...
void get_stat_ad(int point_id)
{
    ...
    TCachedQuery Qry(
            ...
            "   salons.get_seat_no(pax.pax_id,pax.seats,pax.is_jmp,pax_grp.status,pax_grp.point_dep,'_seats',rownum,0) AS seat_no, "
            "   salons.get_seat_no(pax.pax_id,pax.seats,pax.is_jmp,pax_grp.status,pax_grp.point_dep,'_seats',rownum,1) AS seat_no_lat, "
            "   pax.pax_id, "
            "   points.scd_out "
            "from "
            "   points, "
