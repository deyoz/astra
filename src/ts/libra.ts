...
$(CHANGE_CHECKIN $(get pax_id_adl2) AGAFONOV "DENIS DMITRIEVICH" ВЗ Э bag_pool_num=1)
</passengers>})
}
{<value_bags/>
<bags>
$(BAG_WT 1 "" ЮТ pr_cabin=1 amount=2  weight=13   bag_pool_num=1)
$(BAG_WT 2 "" ЮТ pr_cabin=0 amount=10 weight=75 bag_pool_num=1)
</bags>
<tags pr_print=\"0\">
    ...
    &lt;compon plan_id='1' conf_id='1' comp_id='...'...&gt;
      ...
      &lt;baggage&gt;
        &lt;dest val='АМС'&gt;
          ...
          &lt;class bagamount='10' bagweight='75'&gt;Э&lt;/class&gt;
        &lt;/dest&gt;
        &lt;dest val='ПРХ'&gt;
...
!!
$(CANCEL_PAX $(get pax_id_chekmarev) $(get grp_id) $(get tid) $(get point_dep) $(get point_arv) ЮТ 298 СОЧ ПРХ CHEKMAREV KONSTANTIN 2986145143701 ВЗ)

$(set grp_id $(get_single_grp_id $(get pax_id_tumali)))
$(set tid $(get_single_tid $(get pax_id_tumali)))
!!
$(CANCEL_PAX $(get pax_id_tumali) $(get grp_id) $(get tid) $(get point_dep) $(get point_arv) ЮТ 298 СОЧ ПРХ TUMALI VALERII 2986145115578 ВЗ)

$(CHANGE_TCHECKIN_REQUEST capture=off lang=EN hall=1
{$(CHANGE_CHECKIN_SEGMENT $(get point_dep) $(get point_arv1) СОЧ АМС
                          $(get grp_id2) $(get_single_grp_tid $(get pax_id_adl1))
{<passengers>
$(CHANGE_CHECKIN $(get pax_id_adl1) КОТЛЯР "ВЛАДИМИР НИКОЛАЕВИЧ" ВЗ Э bag_pool_num="" refuse=А)
$(CHANGE_CHECKIN $(get pax_id_adl2) AGAFONOV "DENIS DMITRIEVICH" ВЗ Э bag_pool_num="" refuse=А)
</passengers>})
})
...
!!
$(CANCEL_PAX $(get pax_id_pupkin) $(get grp_id) $(get tid) $(get point_dep) $(get point_arv1) ЮТ 298 СОЧ АМС PUPKIN VASYA "" ВЗ)
