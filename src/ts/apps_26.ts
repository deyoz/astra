...
$(init_apps ЮТ ЦЗ APPS_26 closeout=true)
...
$(CHECKIN_PAX_WITH_VISA $(get pax_id) $(get point_dep) $(get point_arv)
                        ЮТ 298 СОЧ ПРХ TUMALI VALERII 2986145115578 ВЗ
...
$(CHECKIN_CREW_WITH_VISA $(get point_dep) $(get point_arv)
                         ЮТ 298 СОЧ ПРХ VOLODIN SEMEN ВЗ
...
$(init_apps ЮТ ЦЗ APPS_26 closeout=false)
...
# уходят CIRQ-запросы
$(CIRQ_61_UT_REQS_APPS_VERSION_26 UT 298 AER PRG)
...
$(CHECKIN_PAX_WITH_VISA_AND_DOCA $(get pax_id) $(get point_dep) $(get point_arv)
                                 ЮТ 298 СОЧ ПРХ TUMALI VALERII 2986145115578 ВЗ
                                 UA FA144642 UA 16.04.1968 25.06.2025 M
                                 213121 CZ 10.03.2019 10.03.2023 CZ)
...
>> lines=auto mode=regex
.*CIRQ:([0-9]+)/UTUTA1/N//26/INT/8/S/UT298/AER/PRG/$(yyyymmdd)/101500/$(yyyymmdd)/110000/PRQ/34/1/P/UKR/UKR/FA144642//P//20250625////TUMALI/VALERII/19680416/M///N/N///////00011////////PAD/13/1/CZ/V//213121/CZE/20230310/ADDRESS/CITY/REGION/112233.*
...
!!
$(CHECKIN_PAX_WITH_VISA $(get pax_id) $(get point_dep) $(get point_arv)
                        ЮТ 298 СОЧ ПРХ SELIVANOV "RUSLAN NAILYEVICH" 2985085963078 ВЗ
                        UA 12342131 UA 23.09.1983 20.12.2025 M
                        56573563 CZ 10.03.2019 10.03.2023 CZ)
...
>> lines=auto mode=regex
.*CICX:([0-9]+)/UTUTA1/N/P/26/INT/8/S/UT298/AER/PRG/$(yyyymmdd)/101500/$(yyyymmdd)/110000/PCX/21/1/4/P/KAZ/KAZ/N11024936//P/20261004////ALIMOV/TALGAT/19960511/M///N/N/.*
