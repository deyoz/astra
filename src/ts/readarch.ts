...
$(db_sql PACTS "insert into PACTS(AIRLINE, AIRP, DESCR, FIRST_DATE, LAST_DATE, ID) values ('ЮТ', 'СОЧ', 'ТЕСТ', TO_DATE('$(date_format %Y-%m-%d -30)', 'yyyy-mm-dd'), null, $(db_seq_nextval ID__SEQ))")
...
$(sql "insert into PACTS(AIRLINE, AIRP, DESCR, FIRST_DATE, LAST_DATE, ID) values ('ЮТ', 'СОЧ', 'ТЕСТ', TO_DATE('$(date_format %Y-%m-%d -30)', 'yyyy-mm-dd'), null, $(db_seq_nextval ID__SEQ))")
