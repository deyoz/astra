...
$(sql "update DESKS set VERSION='201707-0195750'")
$(sql "insert into APPS_SETS(AIRLINE, APPS_COUNTRY, FLT_CLOSEOUT, FORMAT, ID, INBOUND, OUTBOUND, PR_DENIAL) values ('ЮТ', 'ЦН', 1, 'IAPI_CN', id__seq.nextval, 1, 1, 0)")
...
$(SAVE_ET_DISP $(get point_dep) 2981212121212 REPIN IVAN ЮТ UTDC UTET G4LK6W DME BJS)
...
>>
$(TKCREQ_ET_COS UTDC UTET $(get ediref_tktreq) ЮТ 2981212121212 1 CK xxxxxx ДМД BJS)
<<
...
>>
UNB+UNOA:4+NORDWIND:ZZ+NIAC:ZZ+xxxxxx:xxxx+$(get ediref_paxlst)0001++IAPI+O'
...
<< h2h=V.\VDLG.WA/E11HCNIAPIR/I11HCNIAPIQ/P01XW\VGYA\$()
UNB+UNOA:4+NIAC:ZZ+NORDWIND:ZZ+190819:0930+$(get ediref_paxlst)++IAPI'
UNG+CUSRES+NIAC:ZZ+NORDWIND:ZZ+190819:0930+1+UN+D:05B'
UNH+11085B94E1F8FA+CUSRES:D:05B:UN:IATA+$(get ediref_paxlst)'
BGM+962'
RFF+TN:2516'
RFF+AF:FV256'
