...
$(CKIN_LIST_PAX $(get pax_id_adl2_1) 2 ВЗРОСЛЫЙ ВТОРОЙ ВНК РЩН(ЮТ461) РЩН(ЮТ461) Э ... "" ""   "2" "22" ""   "52" "0298103999, 0298104000"     $(get grp_id_adl1_1) 12 1 $(get point_arv1) $(get uid))
...
$(CKIN_LIST_PAX $(get pax_id_chd2_1) 4 РЕБЕНОК  ВТОРОЙ ВНК РЩН(ЮТ461) РЩН(ЮТ461) Э ... "" "РБ" "4" "10" "11" ""   "0298103998, 0298104002-004" $(get grp_id_adl1_1) 12 1 $(get point_arv1) $(get uid))
...
$(CKIN_LIST_PAX $(get pax_id_chd3_1) 8 РЕБЕНОК  ТРЕТИЙ ВНК РЩН(ЮТ461) РЩН(ЮТ461) Э ... "" "РБ" ""  ""   ""   ""   ""                           $(get grp_id_chd3_1) 12 1 $(get point_arv1) $(get uid))
    ...
    <unaccomp_bag>
$(CKIN_LIST_BAG ВНК РЩН(ЮТ461) "3" "24" "11" "35" "0298401557, 1298401555-556"  $(get grp_id_unacc1) 1 $(get point_arv1) $(get uid))
...
$(CKIN_LIST_PAX $(get pax_id_adl2_2) 2 ВЗРОСЛЫЙ ВТОРОЙ РЩН "" "" Э ... "" ""   "2" "22" ""   ""   "0298103999, 0298104000"     $(get grp_id_adl1_2) 12 1 $(get point_arv2) $(get uid) 1)
$(CKIN_LIST_PAX $(get pax_id_chd1_2) 3 РЕБЕНОК  ПЕРВЫЙ РЩН "" "" Э ... "" "РБ" ""  ""   ""   ""   ""                           $(get grp_id_adl1_2) 12 1 $(get point_arv2) $(get uid) 1)
$(CKIN_LIST_PAX $(get pax_id_chd2_2) 4 РЕБЕНОК  ВТОРОЙ РЩН "" "" Э ... "" "РБ" "4" "10" "11" ""   "0298103998, 0298104002-004" $(get grp_id_adl1_2) 12 1 $(get point_arv2) $(get uid) 1)
...
$(CKIN_LIST_PAX $(get pax_id_adl1_1) 1 ВЗРОСЛЫЙ ПЕРВЫЙ ВНК РЩН(ЮТ461) РЩН(ЮТ461) Э ... "" ""   ""  ""   ""   ""   ""                           $(get grp_id_adl1_1) 12 1 $(get point_arv1) $(get uid))
$(CKIN_LIST_PAX $(get pax_id_chd1_1) 3 РЕБЕНОК  ПЕРВЫЙ ВНК РЩН(ЮТ461) РЩН(ЮТ461) Э ... "" "РБ" ""  ""   ""   ""   ""                           $(get grp_id_adl1_1) 12 1 $(get point_arv1) $(get uid))
$(CKIN_LIST_PAX $(get pax_id_chd2_1) 4 РЕБЕНОК  ВТОРОЙ ВНК РЩН(ЮТ461) РЩН(ЮТ461) Э ... "" "РБ" "4" "10" "11" "30" "0298103998, 0298104002-004" $(get grp_id_adl1_1) 12 1 $(get point_arv1) $(get uid))
$(CKIN_LIST_PAX $(get pax_id_inf2_1) 6 МЛАДЕНЕЦ ВТОРОЙ ВНК РЩН(ЮТ461) РЩН(ЮТ461) Э ""  0  "РМ" ""  ""   "9"  ""   ""                           $(get grp_id_adl1_1) 12 1 $(get point_arv1) $(get uid))
$(CKIN_LIST_PAX $(get pax_id_chd3_1) 8 РЕБЕНОК  ТРЕТИЙ ВНК РЩН(ЮТ461) РЩН(ЮТ461) Э ... "" "РБ" ""  ""   ""   ""   ""                           $(get grp_id_chd3_1) 12 1 $(get point_arv1) $(get uid))
    </passengers>
    <unaccomp_bag/>
