...
$(LOAD_CACHE AGENCIES)
$(LOAD_AIRLINE_CACHE AIRLINE_BAG_NORMS ЮТ)
$(LOAD_AIRLINE_CACHE AIRLINE_BAG_RATES ЮТ)
...
$(LOAD_AIRLINE_CACHE AIRLINE_EXCHANGE_RATES ЮТ)
$(LOAD_AIRLINE_CACHE AIRLINE_KIOSK_CKIN_SETS ЮТ)
...
$(LOAD_AIRLINE_CACHE AIRLINE_VALUE_BAG_TAXES ЮТ)
$(LOAD_CACHE AIRLINE_VO_SET)
$(LOAD_AIRLINE_CACHE AIRLINE_WEB_CKIN_SETS ЮТ)
$(LOAD_CACHE AIRPS)
...
$(LOAD_TRIP_BAG_NORMS_ETC TRIP_BAG_NORMS 123 0 ЮТ 580)
$(LOAD_TRIP_BAG_NORMS_ETC TRIP_BAG_NORMS2 123 0 ЮТ 580)
$(LOAD_TRIP_BAG_NORMS_ETC TRIP_BAG_RATES 123 0 ЮТ 580)
$(LOAD_TRIP_BAG_NORMS_ETC TRIP_BAG_RATES2 123 0 ЮТ 580)
...
$(LOAD_TRIP_BAG_NORMS_ETC TRIP_VALUE_BAG_TAXES 123 0 ЮТ 580)
$(LOAD_CACHE TRIP_VO)
...
$(cache PIKE EN OUT_FILE_PARAM_SETS $(cache_iface_ver OUT_FILE_PARAM_SETS) ""
  update id:$(get id_out)   old_id:$(get id_out)
         ...
         airp:АНА           old_airp:
         param_name:ДИР     old_param_name:WORKDIR
...
>> lines=auto
      <user_error lexema_id='MSG.CODE_ALREADY_USED_FOR_COUNTRY' code='0'>The value of 'Code (LAT)' RU field is already used in the 'Code (LAT)' field for country РФ</user_error>
...
$(cache PIKE EN PLACE_CALC $(cache_iface_ver PLACE_CALC) ""
  update old_id:$(get id_VKO_AAQ)        id:$(get id_VKO_AAQ)
         old_airp_dep:ВНК                airp_dep:АНА
         old_airp_dep_view:VKO           airp_dep_view:AAQ
         old_airp_arv:АНА                airp_arv:ВНК
         old_airp_arv_view:AAQ           airp_arv_view:VKO
         old_craft:ТУ5                   craft:777
...
$(cache PIKE EN PLACE_CALC $(cache_iface_ver PLACE_CALC) ""
  update old_id:$(get id_VKO_AAQ)        id:$(get id_VKO_AAQ)
         old_airp_dep:АНА                airp_dep:ДМД
         old_airp_dep_view:AAQ           airp_dep_view:DME
         old_airp_arv:ВНК                airp_arv:АНА
...
$(cache PIKE EN PLACE_CALC $(cache_iface_ver PLACE_CALC) ""
  update old_id:$(get id_CEK_AAQ)       id:$(get id_CEK_AAQ)
         old_airp_dep:ЧЛБ               airp_dep:ДМД
         old_airp_dep_view:CEK          airp_dep_view:DME
         old_airp_arv:АНА               airp_arv:АНА
         old_airp_arv_view:AAQ          airp_arv_view:AAQ
         old_craft:ТУ5                  craft:ТУ5
...
$(cache PIKE RU CODESHARE_SETS $(cache_iface_ver CODESHARE_SETS) ""
  insert airline_oper:ФВ flt_no_oper:110 airline_mark:ЮТ flt_no_mark:210 airp_dep:ВНК pr_mark_norms:1 pr_mark_bp:1 pr_mark_rpt:1 first_date:$(get twoDaysAgo) last_date:$(get range3_to) pr_denial:0
)
...
!! capture=on
$(cache PIKE RU CODESHARE_SETS $(cache_iface_ver CODESHARE_SETS) ""
  insert airline_oper:ФВ flt_no_oper:110 airline_mark:ЮТ flt_no_mark:210 airp_dep:ВНК pr_mark_norms:1 pr_mark_bp:1 pr_mark_rpt:1 first_date:$(get range1_from) last_date:$(get range3_to) pr_denial:0
)
>> lines=auto
$(MESSAGE_TAG MSG.CHANGED_DATA_COMMIT)
...
!! capture=on
$(cache PIKE RU CODESHARE_SETS $(cache_iface_ver CODESHARE_SETS) ""
  insert airline_oper:ФВ flt_no_oper:110 airline_mark:ЮТ flt_no_mark:210 airp_dep:ВНК pr_mark_norms:1 pr_mark_bp:1 pr_mark_rpt:1 first_date:$(get range2_from) last_date:$(get range2_to) pr_denial:0
)
>> lines=auto
$(MESSAGE_TAG MSG.CHANGED_DATA_COMMIT)
...
!! capture=on
$(cache PIKE RU CODESHARE_SETS $(cache_iface_ver CODESHARE_SETS) ""
insert airline_oper:ФВ flt_no_oper:110 airline_mark:ЮТ flt_no_mark:210 airp_dep:ВНК pr_mark_norms:1 pr_mark_bp:1 pr_mark_rpt:1 first_date:$(get range1_from) last_date:$(get range1_to) pr_denial:0 days:"1357"
insert airline_oper:ФВ flt_no_oper:110 airline_mark:ЮТ flt_no_mark:210 airp_dep:ВНК pr_mark_norms:1 pr_mark_bp:1 pr_mark_rpt:1 first_date:$(get range2_from) last_date:$(get range2_to) pr_denial:0 days:"246"
insert airline_oper:ФВ flt_no_oper:110 airline_mark:ЮТ flt_no_mark:210 airp_dep:ВНК pr_mark_norms:1 pr_mark_bp:1 pr_mark_rpt:1 first_date:$(get range3_from) last_date:$(get range3_to) pr_denial:0 days:"147"
)
...
!! capture=on
$(cache PIKE RU CODESHARE_SETS $(cache_iface_ver CODESHARE_SETS) ""
delete old_airline_oper:ФВ old_flt_no_oper:110 old_airline_mark:ЮТ old_flt_no_mark:210 old_airp_dep:ВНК old_id:$(get range1_id)
delete old_airline_oper:ФВ old_flt_no_oper:110 old_airline_mark:ЮТ old_flt_no_mark:210 old_airp_dep:ВНК old_id:$(get range2_id)
delete old_airline_oper:ФВ old_flt_no_oper:110 old_airline_mark:ЮТ old_flt_no_mark:210 old_airp_dep:ВНК old_id:$(get range3_id)
)
...
!! capture=on
$(cache PIKE RU CODESHARE_SETS $(cache_iface_ver CODESHARE_SETS) ""
update old_airline_oper:ФВ old_flt_no_oper:110 old_airline_mark:ЮТ old_flt_no_mark:210 old_airp_dep:ВНК old_id:$(get range6_id) last_date:$(get range1_from)
)
...
!! capture=on
$(cache PIKE RU CODESHARE_SETS $(cache_iface_ver CODESHARE_SETS) ""
delete old_airline_oper:ФВ old_flt_no_oper:110 old_airline_mark:ЮТ old_flt_no_mark:210 old_airp_dep:ВНК old_id:$(get range4_id)
delete old_airline_oper:ФВ old_flt_no_oper:110 old_airline_mark:ЮТ old_flt_no_mark:210 old_airp_dep:ВНК old_id:$(get range5_id)
update old_airline_oper:ФВ old_flt_no_oper:110 old_airline_mark:ЮТ old_flt_no_mark:210 old_airp_dep:ВНК old_id:$(get range6_id) last_date:$(get range3_to2)
)
>> lines=auto
<?xml version='1.0' encoding='CP866'?>
<term>
...
!! capture=on
$(cache PIKE RU CODESHARE_SETS $(cache_iface_ver CODESHARE_SETS) ""
insert airline_oper:ФВ flt_no_oper:110 airline_mark:ЮТ flt_no_mark:210 airp_dep:ВНК pr_mark_norms:1 pr_mark_bp:1 pr_mark_rpt:1 first_date:$(get range3_from) last_date:$(get range3_to2) pr_denial:0 days:"1..4..7"
)
>> lines=auto
<?xml version='1.0' encoding='CP866'?>
<term>
