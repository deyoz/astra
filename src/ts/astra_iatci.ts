...
>> lines=auto
    <data>
      <printBP>
        ...
        <passengers>
          <pax pax_id...
            <prn_form hex='0'>CP{#}1C01{#}01K{#}02{#}02REPIN IVAN                                        {#}03ДОМОДЕДОВО {#}04ПУЛКОВО    {#}05 ЮТ103  {#}0708.06{#}091     {#}0A09:35{#}0BЭ{#}0C    1A{#}0D0KGS{#}0EETKT2986120030297/1  {#}0F7774441110     {#}20REPIN IVAN          {#}21ДОМОДЕДОВО          {#}22ПУЛКОВО             {#}25 ЮТ103  {#}27xx.xx{#}2BЭ{#}2C  1A  {#}3F000000xxxx{#}F1001{#}FF                                                                        {#}</prn_form>
          </pax>
          <pax pax_id...
            <prn_form hex='0'>CP{#}1C01{#}01K{#}02{#}02REPIN IVAN                                        {#}03ПУЛКОВО    {#}04СОЧИ       {#}05 С71027 {#}0708.06{#}09?     {#}0A?{#}0BЭ{#}0C    1A{#}0D0KGS{#}0EETKT4216120030297/2  {#}0F5408123432     {#}20REPIN IVAN          {#}21ПУЛКОВО             {#}22СОЧИ                {#}25 С71027 {#}27xx.xx{#}2BЭ{#}2C  1A  {#}3F2000000000{#}F1001{#}FF                                                                        {#}</prn_form>
          </pax>
        </passengers>
      </printBP>
    </data>
