...
>> lines=auto
    <data>
      <printBP>
        ...
        <passengers>
          <pax pax_id...
            <prn_form hex='0'>0,20,0,ACT:             '$(date_format %d.%m.%Y) 10:00:00                     ' 0,25,0,AGENT:           'PIKE                                    ' 0,30,0,AIRLINE:         'ЮТ                                      ' 0,35,0,AIRLINE_NAME:    'ОАО АВИАКОМПАНИЯ ЮТЭЙР                  ' 0,40,0,AIRLINE_SHORT:   'ЮТЭЙР                                   ' 0,45,0,AIRP_ARV:        'ПЛК                                     ' 0,50,0,AIRP_ARV_NAME:   'ПУЛКОВО                                 ' 0,55,0,AIRP_DEP:        'ДМД                                     ' 0,60,0,AIRP_DEP_NAME:   'ДОМОДЕДОВО                              ' 0,65,0,BAG_AMOUNT:      '0                                       ' 0,70,0,BAGGAGE:         '                                        ' 0,75,0,BAG_WEIGHT:      '0                                       ' 0,80,0,BCBP_M_2:        'M1REPIN/IVAN          E0840Z6 DMELEDUT 0103 161Y001A0001 128&gt;2180OO    B                00000000$(get pax_id)' 0,85,0,BRD_FROM:        '$(date_format %d.%m.%Y) 09:15:00                     ' 0,90,0,BRD_TO:          '$(date_format %d.%m.%Y) 09:35:00                     ' 0,95,0,CHD:             '                                        ' 0,100,0,CITY_ARV_NAME:  'САНКТ-ПЕТЕРБУРГ                         ' 0,105,0,CITY_DEP_NAME:  'МОСКВА                                  ' 0,110,0,CLASS:          'Э                                       ' 0,115,0,CLASS_NAME:     'ЭКОНОМ                                  ' 0,120,0,DESK:           'МОВРОМ                                  ' 0,125,0,DOCUMENT:       '7774441110                              ' 0,130,0,DUPLICATE:      '                                        ' 0,135,0,EST:            '$(date_format %d.%m.%Y) 10:00:00                     ' 0,140,0,ETICKET_NO:     '2986120030297/1                         ' 0,145,0,ETKT:           'ETKT2986120030297/1                     ' 0,150,0,EXCESS:         '0                                       ' 0,155,0,FLT_NO:         '103                                     ' 0,160,0,FQT:            '                                        ' 0,165,0,FULLNAME:       'REPIN IVAN                              ' 0,170,0,FULL_PLACE_ARV: 'САНКТ-ПЕТЕРБУРГ ПУЛКОВО                 ' 0,175,0,FULL_PLACE_DEP: 'МОСКВА ДОМОДЕДОВО                       ' 0,180,0,GATE:           '1                                       ' 0,185,0,GATES:          '                                        ' 0,190,0,HALL:           'Зал 1                                   ' 0,195,0,INF:            '                                        ' 0,200,0,LIST_SEAT_NO:   '1A                                      ' 0,205,0,LONG_ARV:       'САНКТ-ПЕТЕРБУРГ(ПЛК)/ST PETERSBURG(LED) ' 0,210,0,LONG_DEP:       'МОСКВА(ДМД)/MOSCOW(DME)                 ' 0,215,0,NAME:           'IVAN                                    ' 0,220,0,NO_SMOKE:       'X                                       ' 0,225,0,ONE_SEAT_NO:    '1A                                      ' 0,230,0,PAX_ID:         '000000$(get pax_id)                              ' 0,235,0,PAX_TITLE:      'Г-Н                                     ' 0,240,0,PLACE_ARV:      'САНКТ-ПЕТЕРБУРГ(ПЛК)                    ' 0,245,0,PLACE_DEP:      'МОСКВА(ДМД)                             ' 0,250,0,PNR:            '0840Z6                                  ' 0,255,0,REG_NO:         '001                                     ' 0,260,0,REM:            '                                        ' 0,265,0,RK_AMOUNT:      '0                                       ' 0,270,0,RK_WEIGHT:      '0                                       ' 0,275,0,RSTATION:       '                                        ' 0,280,0,SCD:            '$(date_format %d.%m.%Y) 10:00:00                     ' 0,285,0,SEAT_NO:        '1A                                      ' 0,290,0,STR_SEAT_NO:    '1A                                      ' 0,295,0,SUBCLS:         'Э                                       ' 0,300,0,SURNAME:        'REPIN                                   ' 0,305,0,TAGS:           '                                        ' 0,310,0,TEST_SERVER:    '                                        ' 0,315,0,TIME_PRINT:     '$(date_format %d.%m.%Y) xx:xx:xx                     '</prn_form>
          </pax>
          <pax pax_id...
            <prn_form hex='0'>0,20,0,ACT:             '$(date_format %d.%m.%Y) 10:00:00                     ' 0,25,0,AGENT:           'PIKE                                    ' 0,30,0,AIRLINE:         'С7                                      ' 0,35,0,AIRLINE_NAME:    'АВИАКОМПАНИЯ СИБИРЬ                     ' 0,40,0,AIRLINE_SHORT:   'СИБИРЬ                                  ' 0,45,0,AIRP_ARV:        'СОЧ                                     ' 0,50,0,AIRP_ARV_NAME:   'СОЧИ                                    ' 0,55,0,AIRP_DEP:        'ПЛК                                     ' 0,60,0,AIRP_DEP_NAME:   'ПУЛКОВО                                 ' 0,65,0,BAG_AMOUNT:      '0                                       ' 0,70,0,BAGGAGE:         '                                        ' 0,75,0,BAG_WEIGHT:      '0                                       ' 0,80,0,BCBP_M_2:        '' 0,85,0,BRD_FROM:        '$(date_format %d.%m.%Y) xx:xx:xx                     ' 0,90,0,BRD_TO:          '$(date_format %d.%m.%Y) xx:xx:xx                     ' 0,95,0,CHD:             '                                        ' 0,100,0,CITY_ARV_NAME:  'СОЧИ                                    ' 0,105,0,CITY_DEP_NAME:  'САНКТ-ПЕТЕРБУРГ                         ' 0,110,0,CLASS:          '                                        ' 0,115,0,CLASS_NAME:     '                                        ' 0,120,0,DESK:           'МОВРОМ                                  ' 0,125,0,DOCUMENT:       '5408123432                              ' 0,130,0,DUPLICATE:      '                                        ' 0,135,0,EST:            '$(date_format %d.%m.%Y) 10:00:00                     ' 0,140,0,ETICKET_NO:     '2986120030297/1                         ' 0,145,0,ETKT:           'ETKT4216120030297/2                     ' 0,150,0,EXCESS:         '0                                       ' 0,155,0,FLT_NO:         '1027                                    ' 0,160,0,FQT:            '                                        ' 0,165,0,FULLNAME:       'REPIN IVAN                              ' 0,170,0,FULL_PLACE_ARV: 'СОЧИ                                    ' 0,175,0,FULL_PLACE_DEP: 'САНКТ-ПЕТЕРБУРГ ПУЛКОВО                 ' 0,180,0,GATE:           '                                        ' 0,185,0,GATES:          '                                        ' 0,190,0,HALL:           '                                        ' 0,195,0,INF:            '                                        ' 0,200,0,LIST_SEAT_NO:   'xx                                      ' 0,205,0,LONG_ARV:       'СОЧИ(СОЧ)/SOCHI(AER)                    ' 0,210,0,LONG_DEP:       'САНКТ-ПЕТЕРБУРГ(ПЛК)/ST PETERSBURG(LED) ' 0,215,0,NAME:           'IVAN                                    ' 0,220,0,NO_SMOKE:       'X                                       ' 0,225,0,ONE_SEAT_NO:    'xx                                      ' 0,230,0,PAX_ID:         '2000000000                              ' 0,235,0,PAX_TITLE:      '                                        ' 0,240,0,PLACE_ARV:      'СОЧИ(СОЧ)                               ' 0,245,0,PLACE_DEP:      'САНКТ-ПЕТЕРБУРГ(ПЛК)                    ' 0,250,0,PNR:            '                                        ' 0,255,0,REG_NO:         '001                                     ' 0,260,0,REM:            '                                        ' 0,265,0,RK_AMOUNT:      '0                                       ' 0,270,0,RK_WEIGHT:      '0                                       ' 0,275,0,RSTATION:       '                                        ' 0,280,0,SCD:            '$(date_format %d.%m.%Y) 10:00:00                     ' 0,285,0,SEAT_NO:        'xx                                      ' 0,290,0,STR_SEAT_NO:    '1A                                      ' 0,295,0,SUBCLS:         'Э                                       ' 0,300,0,SURNAME:        'REPIN                                   ' 0,305,0,TAGS:           '                                        ' 0,310,0,TEST_SERVER:    '                                        ' 0,315,0,TIME_PRINT:     '$(date_format %d.%m.%Y) xx:xx:xx                     '</prn_form>
          </pax>
        </passengers>
      </printBP>
    </data>
