    ...
    <data>
      <printBP>
        ...
        <passengers>
          ...
          <pax pax_id...
            <prn_form hex='0'>CP{#}1C01{#}01K{#}02{#}02REPIN IVAN                                        {#}03ПУЛКОВО    {#}04СОЧИ       {#}05 С71027 {#}07$(date_format %d.%m +0){#}09      {#}0A11:55{#}0B {#}0C    7A{#}0DKGS{#}0EETKT2986120030297/2  {#}0F5408123432     {#}20REPIN IVAN          {#}21ПУЛКОВО             {#}22СОЧИ                {#}25 С71027 {#}27$(date_format %d.%m +0){#}2B {#}2C  7A  {#}3F2000000000{#}F1032{#}FF                                                                        {#}</prn_form>
          </pax>
        </passengers>
      </printBP>
    </data>
