...
>> lines=auto
    <data>
      <printBP>
        ...
        <passengers>
          <pax pax_id...
            <prn_form hex='0'>CP{#}1C01{#}01K{#}02{#}02РЕПИН ИВАН{#}03ДОМОДЕДОВО{#}04ПУЛКОВО{#}05 ЮТ103{#}07$(date_format %d.%m +0){#}091{#}0A09:50{#}0BЭ{#}0C    1A{#}0DKGS{#}0EETKT2981212121212/1{#}0F7774441110{#}20РЕПИН ИВАН{#}21ДОМОДЕДОВО{#}22ПУЛКОВО{#}25 ЮТ103{#}27$(date_format %d.%m +0){#}2BЭ{#}2C  1A{#}3Fxxxxxxxxxx{#}F1001{#}FF{#}</prn_form>
          </pax>
        </passengers>
      </printBP>
    </data>
