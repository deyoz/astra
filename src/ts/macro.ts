...
<term>
  <query handle='0' id='stat' ver='1' opr='PIKE' screen='STAT.EXE' mode='STAND' lang='RU' term_id='2479792165'>
    <run_stat>
      ...
      <stat_mode>èÆ§‡Æ°≠†Ô</stat_mode>
      <stat_type>í‡†≠·‰•‡</stat_type>
...
<term>
  <query handle='0' id='stat' ver='1' opr='PIKE' screen='STAT.EXE' mode='STAND' lang='RU' term_id='2479792165'>
    <SystemLogRun>
      ...
      <evtPax>èÄë</evtPax>
      <evtPay>éèã</evtPay>
      <evtGraph>Éêî</evtGraph>
      <evtFltTask>áÑó</evtFltTask>
      <evtTlg>íãÉ</evtTlg>
      <evtComp>äåè</evtComp>
      <evtAccess>Ñëí</evtAccess>
      <evtSystem>ëàë</evtSystem>
      <evtCodif>äéÑ</evtCodif>
      <evtPeriod>èêÑ</evtPeriod>
      <evtSeason>ëÖá</evtSeason>
      <evtDisp>Ñàë</evtDisp>
      <client_with_trip_col_in_SysLog/>
      <LoadForm/>
    </SystemLogRun>
...
####################################################################################
### ®ß¨•≠•≠®• ≠†·‚‡Æ•™ ‡•©·† ¢ trip_sets (£†´ÆÁ™® ¢ £´†¢≠Æ¨ Ì™‡†≠• "èÆ§£Æ‚Æ¢™®")

$(defmacro CHANGE_TRIP_SETS
  point_dep     #•§®≠·‚¢•≠≠Î© Ø†‡†¨•‚‡, ™Æ‚Æ‡Î© §Æ´¶•≠ °Î‚Ï ≠•Ø„·‚Î¨
  pr_tranzit
  pr_tranz_reg
  trzt_bort_changing
