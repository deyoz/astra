...
### test 8
### тестирование функции вывода номеров PNR из PNL
#########################################################################################
...
??
$(pnr_addr_by_pax_id $(get pax_id_) "СУ")
>>
$(result1)

??
$(pnr_addr_by_pax_id $(get pax_id_) "ЮТ")
>>
$(result2)

??
$(pnr_addr_by_pax_id $(get pax_id_) "ФВ")
>>
$(result3)
...
-GOI006Y
1ПАССБЕЗPNR/A
1ПАССОДНОPNRРОДНОЕ/A
.L/ФВ1234/FV
1ПАССОДНОPNRНЕРОДНОЕ/A
.L/ЮТ9876/UT
1ПАССТРИPNRСРОДНЫМ/A
.L/ЮТ9875/UT
.L/ФВ1235/FV
.L/СУ4567/SU
1ПАССТРИPNRБЕЗРОДНОГО/ПЕРВЫЙ-A2
.L/ЮТ9874/UT
.L/S75555/S7
.L/СУ4568/SU
1ПАССТРИPNRБЕЗРОДНОГО/ВТОРОЙ-A2
ENDPNL
...
$(CHECK_PNR_ADDR_BY_PAX_ID ПАССБЕЗPNR A                "| СУ|"       "| ЮТ|"       "| ФВ|"       "| ФВ|"      )
$(CHECK_PNR_ADDR_BY_PAX_ID ПАССОДНОPNRРОДНОЕ A         "| СУ|"       "| ЮТ|"       "|ФВ1234 ФВ|" "|ФВ1234 ФВ|")
$(CHECK_PNR_ADDR_BY_PAX_ID ПАССОДНОPNRНЕРОДНОЕ A       "| СУ|"       "|ЮТ9876 ЮТ|" "| ФВ|"       "| ФВ|"      )
$(CHECK_PNR_ADDR_BY_PAX_ID ПАССТРИPNRСРОДНЫМ A         "|СУ4567 СУ|" "|ЮТ9875 ЮТ|" "|ФВ1235 ФВ|" "|ФВ1235 ФВ|")
$(CHECK_PNR_ADDR_BY_PAX_ID ПАССТРИPNRБЕЗРОДНОГО ПЕРВЫЙ "|СУ4568 СУ|" "|ЮТ9874 ЮТ|" "| ФВ|"       "| ФВ|"      )
$(CHECK_PNR_ADDR_BY_PAX_ID ПАССТРИPNRБЕЗРОДНОГО ВТОРОЙ "|СУ4568 СУ|" "|ЮТ9874 ЮТ|" "| ФВ|"       "| ФВ|"      )

$(CHECK_FIRST_PNR_ADDR_BY_PAX_ID ПАССБЕЗPNR A                "||" "||")
$(CHECK_FIRST_PNR_ADDR_BY_PAX_ID ПАССОДНОPNRРОДНОЕ A         "|ФВ1234|" "|ФВ1234/ФВ|")
$(CHECK_FIRST_PNR_ADDR_BY_PAX_ID ПАССОДНОPNRНЕРОДНОЕ A       "|ЮТ9876|" "|ЮТ9876/ЮТ|")
$(CHECK_FIRST_PNR_ADDR_BY_PAX_ID ПАССТРИPNRСРОДНЫМ A         "|ФВ1235|" "|ФВ1235/ФВ|")
$(CHECK_FIRST_PNR_ADDR_BY_PAX_ID ПАССТРИPNRБЕЗРОДНОГО ПЕРВЫЙ "|S75555|" "|S75555/С7|")
$(CHECK_FIRST_PNR_ADDR_BY_PAX_ID ПАССТРИPNRБЕЗРОДНОГО ВТОРОЙ "|S75555|" "|S75555/С7|")
